 ;xobw.RestRequestFactory.1
 ;(C)InterSystems, generated for class xobw.RestRequestFactory.  Do NOT edit. 03/03/2011 09:29:06AM
 ;;00BD3B32F0505D63;xobw.RestRequestFactory
 ;
...
%ClassName(fullname) public {
	Quit $select($get(fullname,0):"xobw.RestRequestFactory",1:"RestRequestFactory") }
...
%ConstructClone(%this,deep=0,cloned,location) public {
	...
	Set object=%this,%this=$zobjnew("xobw.RestRequestFactory"),cloned(+object)=%this,cloned(+object,0)=object Set $zobjmod(,0)=1
...
%Extends(isclass) public {
	Quit ''$listfind($listbuild("xobw.RestRequestFactory","%Library.RegisteredObject"),$s(isclass[".":isclass,$e(isclass)'="%":"User."_isclass,1:"%Library."_$e(isclass,2,*))) }
...
%ValidateObject(%this,force=0)
	Quit 1
zcreateRestRequest(%this,webServerName) public {
...
zsetUpCredentials(%this,webServer,restRequest) public {
	...
	quit }
zsetUpServer(%this,webServer,restRequest) public {
